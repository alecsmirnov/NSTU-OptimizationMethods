...
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%7D%5Cin%20D). Приняв эту точку за исходную и используя некоторый детерминированный метод или алгоритм направленного случайного поиска, осуществляется спуск в точку локального минимума 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%5Cin%20D), 
в области притяжения которого оказалась точка 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%7D).  
Затем выбирается новая случайная точка 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%7D%5Cin%20D)
и по той же схеме осуществляется спуск в точку локального минимума 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D%5Cin%20D)
, и т.д.  
...
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%5Cin%20D). После этого переходим к *ненаправленному случайному поиску* до получения точки 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%7D) такой, что 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B2%7D%7D%29%20%3C%20f%28%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%29).  
Из точки 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%7D) с помощью детерминированного алгоритма или направленного случайного поиска получаем точку локального экстремума 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D), 
в которой заведомо выполняется неравенство 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D%29%3Cf%28%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%29).  
Далее с помощью случайного поиска определяем новую точку 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B3%7D%7D), 
для которой справедливо неравенство 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B3%7D%7D%29%3Cf%28%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D%29), 
и снова спуск в точку локального экстремума 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B3%7D%5E%7B*%7D%7D), и т.д.  
...
&nbsp;  
    * **Алгоритм 3**.  
    Пусть 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B0%7D%7D) 
– некоторая исходная точка поиска в области *D*, из которой осуществляется спуск в точку локального экстремума 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D) 
со значением 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%29). 
Далее из точки 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D) 
движемся либо в случайном направлении, либо в направлении 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D-%5Coverline%7Bx_%7B1%7D%5E%7B0%7D%7D) 
до тех пор, пока функция снова не станет убывать (выходим из области притяжения 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D)).  
Полученная точка 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%5E%7B0%7D%7D) 
принимается за начало следующего спуска. В результате находим новый локальный экстремум 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D)
со значением функции 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D%29).  
Если 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D%29%3Cf%28%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%29), точка 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D) 
забывается и ее место занимает точка 
![](https://latex.codecogs.com/svg.latex?%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D).
Если 
![](https://latex.codecogs.com/svg.latex?f%28%5Coverline%7Bx_%7B2%7D%5E%7B*%7D%7D%29%5Cgeq%20f%28%5Coverline%7Bx_%7B1%7D%5E%7B*%7D%7D%29), 
